...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/KTV-Project/KTV/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/ktv-project/ktv/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/ktv-project/ktv-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/ktv-project/ktv.git
...
- Detached signatures will then be committed to the [ktv-detached-sigs](https://github.com/ktv-Project/ktv-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/KTV-Project/KTV/releases/new) with a link to the archived release notes.
