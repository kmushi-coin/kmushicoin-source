...
This document provides guidelines for internationalization of the KTV software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to KTV network</source>
        <translation>
            <numerusform>%n active connection to KTV network</numerusform>
            <numerusform>%n active connections to KTV network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ktv_en.ts` remains unchanged.
