...
const string strMessageMagic = "KmushiCoin Signed Message:\n";
...
bool CBlock::AcceptBlock()
{
    ...
    if (IsProofOfWork() && nHeight > LAST_POW_BLOCK && nHeight < POW_RE_ENABLE)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "KmushiCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1557011854;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1348657 : 1348657;
        ...
        assert(block.hashMerkleRoot == uint256("0x68033db0f8c8a73524e37b2c10d3188b01ba3dac99082e96fd482e49183ff709"));
