...
"""Verify that starting ktv with -h works as expected."""
...
class HelpTest(KtvTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ktv with -? for help text")
        ...
        self.log.info("Start ktv with -version for version information")
