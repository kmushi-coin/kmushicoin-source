...
class DIP3Test(KtvTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 KTV) to the operator, and (2 * 2.7 KTV) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid KTV address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid KTV address InvalidPayee", controller.protx_update_registrar,
