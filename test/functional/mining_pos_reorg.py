...
class ReorgStakeTest(KtvTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        ktv_supply = [self.nodes[i].getsupplyinfo(True)['transparentsupply']
                      for i in range(self.num_nodes)]
        assert_equal(ktv_supply, [DecimalAmt(expected_ktv)] * self.num_nodes)
    ...
    def run_test(self):
        ...
        # Verify that KTV supply was properly updated after the reorgs (including burned fee)
        self.log.info("Check KTV supply...")
