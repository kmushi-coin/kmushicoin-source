...
class FullBlockTest(KtvTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure ktvd isn't accepting b26
        ...
        # Extend the b28 chain to make sure ktvd isn't accepting b28
        ...
        # KTV: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the ktv code has custom code which does so);
