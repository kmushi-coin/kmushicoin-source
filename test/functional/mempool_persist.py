...
By default, ktvd will dump mempool on shutdown and
...
class MempoolPersistTest(KtvTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent ktvd from writing mempool.dat to disk. Verify that `savemempool` fails")
