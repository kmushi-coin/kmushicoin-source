...
class NetTest(KtvTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 36599)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 36599)
