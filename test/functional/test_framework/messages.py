...
COIN = 100000000 # 1 KTV in satoshis
...
# Objects that map to ktvd objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in ktvd indicates these should be deserialized as blocks
