...
class ListReceivedTest (KtvTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 KTV.
        ...
        # Send 1 KTV to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 KTV sending them all (fee is 0.1 KTV)
        ...
        # Confirm transaction (2 KTV from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 KTV, send 0.6 KTV + 0.05 KTV fee
