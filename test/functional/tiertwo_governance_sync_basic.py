...
from test_framework.test_framework import KtvTier2TestFramework
...
class MasternodeGovernanceBasicTest(KtvTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.kmushicoin.co/t/test-proposal",
            2,
