...
RESOURCES += src/qt/ktv.qrc src/qt/ktv_locale.qrc

TRANSLATIONS += src/qt/locale/ktv_bg.ts \
                src/qt/locale/ktv_de.ts \
                src/qt/locale/ktv_en.ts \
                src/qt/locale/ktv_es.ts \
                src/qt/locale/ktv_fi.ts \
                src/qt/locale/ktv_fr.ts \
                src/qt/locale/ktv_it.ts \
                src/qt/locale/ktv_ja.ts \
                src/qt/locale/ktv_pl.ts \
                src/qt/locale/ktv_pt.ts \
                src/qt/locale/ktv_ru.ts \
                src/qt/locale/ktv_sk.ts \
                src/qt/locale/ktv_sv.ts \
                src/qt/locale/ktv_vi.ts \
                src/qt/locale/ktv_zh_CN.ts \
                src/qt/locale/ktv_zh_TW.ts
