...
The KTV project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/kmushi-coin/kmushicoin-source/blob/master/doc/translation_process.md)
...
The following applies to code changes to the KTV project, and is not to be
confused with overall KTV Network Protocol consensus changes.

Whether a pull request is merged into KTV rests with the project merge
...
Patches that change KTV consensus rules are considerably more involved than
...
Where a patchset proposes to change the KTV consensus, it must have been
...
The project leader is the release manager for each KTV release.
