...
enum WalletFeature {
    ...
    FEATURE_PRE_KTV = 61000, // inherited version..
...
public:
     ...
     * KTV: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 KTV output and keys which can be used for the Masternode
