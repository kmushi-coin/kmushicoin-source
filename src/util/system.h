...
extern const char * const KTV_CONF_FILENAME;
extern const char * const KTV_PID_FILENAME;
extern const char * const KTV_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("ktv-%s", name);
