...
#include "config/ktv-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalKtv = 0;
    qint64 totalZktv = 0;
    QList<qreal> valuesKtv;
    QList<qreal> valueszKtv;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(KTVGUI* _window);
    ~DashboardWidget();
