...
#include "qt/ktv/forms/ui_masternodewizarddialog.h"
    ...
    clientModel(_clientModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a KTV Masternode you must dedicate %1 (the unit of KTV) "
