...
#include "qt/ktv/forms/ui_masternodeswidget.h"

#include "qt/ktv/qtutils.h"
#include "qt/ktv/mnrow.h"
#include "qt/ktv/mninfodialog.h"
#include "qt/ktv/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(KTVGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:36599 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::KTV)));
        return;
    }
    showHideOp(true);
