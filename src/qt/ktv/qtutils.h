...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, KTVGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, KTVGUI* gui, double posX = 3);
