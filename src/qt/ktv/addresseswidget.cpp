...
#include "qt/ktv/forms/ui_addresseswidget.h"
#include "qt/ktv/addressfilterproxymodel.h"
#include "qt/ktv/addresslabelrow.h"
...
AddressesWidget::AddressesWidget(KTVGUI* parent) :
    PWidget(parent),
