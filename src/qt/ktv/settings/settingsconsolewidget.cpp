...
#include "qt/ktv/settings/forms/ui_settingsconsolewidget.h"
...
SettingsConsoleWidget::SettingsConsoleWidget(KTVGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(RPCExecutor::CMD_REPLY, (tr("Welcome to the KTV RPC console.") + "<br>" +
