...
#include "qt/ktv/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ktv/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(KTVGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to KTVGUI::handleRestart()
