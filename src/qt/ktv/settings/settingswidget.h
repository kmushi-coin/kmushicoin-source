...
#include "qt/ktv/settings/settingsbackupwallet.h"
#include "qt/ktv/settings/settingsexportcsv.h"
#include "qt/ktv/settings/settingsbittoolwidget.h"
#include "qt/ktv/settings/settingssignmessagewidgets.h"
#include "qt/ktv/settings/settingswalletrepairwidget.h"
#include "qt/ktv/settings/settingswalletoptionswidget.h"
#include "qt/ktv/settings/settingsmainoptionswidget.h"
#include "qt/ktv/settings/settingsdisplayoptionswidget.h"
#include "qt/ktv/settings/settingsinformationwidget.h"
#include "qt/ktv/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(KTVGUI* parent);
    ~SettingsWidget();
