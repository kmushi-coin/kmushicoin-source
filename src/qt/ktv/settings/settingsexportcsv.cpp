...
#include "qt/ktv/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(KTVGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("KTV_tx_csv_export(*.csv)") : tr("KTV_addresses_csv_export(*.csv)"),
                                        nullptr);
