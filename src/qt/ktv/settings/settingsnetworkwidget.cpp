...
#include "qt/ktv/settings/settingsnetworkwidget.h"
#include "qt/ktv/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ktv/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(KTVGUI* _window, QWidget *parent) :
