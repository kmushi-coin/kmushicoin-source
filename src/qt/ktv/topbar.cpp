...
#include "qt/ktv/topbar.h"
#include "qt/ktv/forms/ui_topbar.h"
#include "qt/ktv/lockunlock.h"
#include "qt/ktv/qtutils.h"
#include "qt/ktv/receivedialog.h"
#include "qt/ktv/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/ktv/balancebubble.h"
...
TopBar::TopBar(KTVGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopKtv, ui->labelAmountTopShieldedKtv}, "amount-small-topbar");
    setCssProperty({ui->labelAmountKtv}, "amount-topbar");
    setCssProperty({ui->labelPendingKtv, ui->labelImmatureKtv}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // KTV Total
    QString totalKtv = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // KTV
    // Top
    ui->labelAmountTopKtv->setText(totalTransparent);
    ui->labelAmountTopShieldedKtv->setText(totalShielded);
    // Expanded
    ui->labelAmountKtv->setText(totalKtv);
    ui->labelPendingKtv->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureKtv->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
