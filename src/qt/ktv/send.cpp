...
#include "qt/ktv/forms/ui_send.h"
#include "qt/ktv/addnewcontactdialog.h"
#include "qt/ktv/qtutils.h"
#include "qt/ktv/sendchangeaddressdialog.h"
#include "qt/ktv/optionbutton.h"
#include "qt/ktv/sendconfirmdialog.h"
#include "qt/ktv/guitransactionsutils.h"
...
SendWidget::SendWidget(KTVGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    coinIcon(new QPushButton())
{
    ...
    ui->btnUri->setSubTitleClassAndText("text-subtitle", tr("Parse a KTV URI"));
    ...
    setCssProperty(coinIcon, "coin-icon-ktv");
