...
#ifndef KTV_CORE_NEW_GUI_KTVGUI_H
#define KTV_CORE_NEW_GUI_KTVGUI_H
...
#include "qt/ktv/navmenuwidget.h"
#include "qt/ktv/topbar.h"
#include "qt/ktv/dashboardwidget.h"
#include "qt/ktv/send.h"
#include "qt/ktv/receivewidget.h"
#include "qt/ktv/addresseswidget.h"
#include "qt/ktv/coldstakingwidget.h"
#include "qt/ktv/masternodeswidget.h"
#include "qt/ktv/snackbar.h"
#include "qt/ktv/settings/settingswidget.h"
...
/**
  KTV GUI main class. This class represents the main window of the KTV UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KTVGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KTVGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~KTVGUI();
...
#endif //KTV_CORE_NEW_GUI_KTVGUI_H
