...
/** Utility functions used by the KTV Qt UI.
 */
namespace GUIUtil
{
...
// Render KTV addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZktv = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZktv = false);
...
// Parse "ktv:" URI into recipient object, return true on successful parsing
