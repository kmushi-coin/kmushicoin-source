...
/* Ktv GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "KTV"
#define QAPP_ORG_DOMAIN "kmushicoin.co"
#define QAPP_APP_NAME_DEFAULT "KTV-Qt"
#define QAPP_APP_NAME_TESTNET "KTV-Qt-testnet"
