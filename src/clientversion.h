...
#error Client version information missing: version is not defined by ktv-config.h or in any other way
#endif
...
/**
 * ktvd-res.rc includes this file, but it cannot cope with real c++ code.
